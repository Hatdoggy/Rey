			...
			<div id="contact" className={mobile?"fade flex flx-col p-20 mid ":"flex flx-col fade_5 p-20"}>
				<form action="" className={mobile?"ml-5 mr-5":"h-70"}>
					<div className="mt-15 flex flx-col">
						<label htmlFor="name" className={mobile?"lato al-ce":"lato"}>Name</label>
						<input type="text" className="bg-trans lato" id="name"/>
					</div>
					<div className="mt-15 flex flx-col">
						<label htmlFor="email" className={mobile?"lato al-ce":"lato"}>Email</label>
						<input type="text" className="bg-trans lato" id="email"/>
					</div>
					<div className="mt-15 flex flx-col">
						<label htmlFor="message" className={mobile?"lato al-ce":"lato"}>Message</label>
						<textarea type="text" className="bg-trans lato" id="message"></textarea>
					</div>
